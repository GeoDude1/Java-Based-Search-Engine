...
public class WorkQueue {
	...
	/**
	 * Variable that tracks unfinished work
	 */
	private int pending;
	...
	public synchronized void finish() {
		try {
			...
			System.out.println("Work queue interrupted while trying to finish.");
		}
	}
